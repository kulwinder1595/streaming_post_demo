...
class LivePartnerScreen extends StatelessWidget {
  var controller = Get.put(LivePartnerController());

  LivePartnerScreen(bool _isHost, streamingUserIds, streamingToken, String streamingJoiningId, bool groupStreaming, String hostId) {
    ...
    controller.dispose();
    controller = Get.put(LivePartnerController());
